...
export type Property$AnimationTimingFunction = Globals | DataType$TimingFunction | string;
...
export type Property$TransitionTimingFunction = Globals | DataType$TimingFunction | string;
...
export type AtRule$Viewport<TLength = string | 0, TTime = string> = {|
  msHeight?: AtRule$Height<TLength>,
  msMaxHeight?: AtRule$MaxHeight<TLength>,
  msMaxWidth?: AtRule$MaxWidth<TLength>,
  msMaxZoom?: AtRule$MaxZoom,
  msMinHeight?: AtRule$MinHeight<TLength>,
  msMinWidth?: AtRule$MinWidth<TLength>,
  msMinZoom?: AtRule$MinZoom,
  msOrientation?: AtRule$Orientation,
  msUserZoom?: AtRule$UserZoom,
  msWidth?: AtRule$Width<TLength>,
  msZoom?: AtRule$Zoom,
  OOrientation?: AtRule$Orientation,
...
export type AtRule$ViewportHyphen<TLength = string | 0, TTime = string> = {|
  "-ms-height"?: AtRule$Height<TLength>,
  "-ms-max-height"?: AtRule$MaxHeight<TLength>,
  "-ms-max-width"?: AtRule$MaxWidth<TLength>,
  "-ms-max-zoom"?: AtRule$MaxZoom,
  "-ms-min-height"?: AtRule$MinHeight<TLength>,
  "-ms-min-width"?: AtRule$MinWidth<TLength>,
  "-ms-min-zoom"?: AtRule$MinZoom,
  "-ms-orientation"?: AtRule$Orientation,
  "-ms-user-zoom"?: AtRule$UserZoom,
  "-ms-width"?: AtRule$Width<TLength>,
  "-ms-zoom"?: AtRule$Zoom,
  "-o-orientation"?: AtRule$Orientation,
  height?: AtRule$Height<TLength>,
...
export type AtRule$ViewportFallback<TLength = string | 0, TTime = string> = {|
  msHeight?: AtRule$Height<TLength> | Array<AtRule$Height<TLength>>,
  msMaxHeight?: AtRule$MaxHeight<TLength> | Array<AtRule$MaxHeight<TLength>>,
  msMaxWidth?: AtRule$MaxWidth<TLength> | Array<AtRule$MaxWidth<TLength>>,
  msMaxZoom?: AtRule$MaxZoom | Array<AtRule$MaxZoom>,
  msMinHeight?: AtRule$MinHeight<TLength> | Array<AtRule$MinHeight<TLength>>,
  msMinWidth?: AtRule$MinWidth<TLength> | Array<AtRule$MinWidth<TLength>>,
  msMinZoom?: AtRule$MinZoom | Array<AtRule$MinZoom>,
  msOrientation?: AtRule$Orientation | Array<AtRule$Orientation>,
  msUserZoom?: AtRule$UserZoom | Array<AtRule$UserZoom>,
  msWidth?: AtRule$Width<TLength> | Array<AtRule$Width<TLength>>,
  msZoom?: AtRule$Zoom | Array<AtRule$Zoom>,
  OOrientation?: AtRule$Orientation | Array<AtRule$Orientation>,
...
export type AtRule$ViewportHyphenFallback<TLength = string | 0, TTime = string> = {|
  "-ms-height"?: AtRule$Height<TLength> | Array<AtRule$Height<TLength>>,
  "-ms-max-height"?: AtRule$MaxHeight<TLength> | Array<AtRule$MaxHeight<TLength>>,
  "-ms-max-width"?: AtRule$MaxWidth<TLength> | Array<AtRule$MaxWidth<TLength>>,
  "-ms-max-zoom"?: AtRule$MaxZoom | Array<AtRule$MaxZoom>,
  "-ms-min-height"?: AtRule$MinHeight<TLength> | Array<AtRule$MinHeight<TLength>>,
  "-ms-min-width"?: AtRule$MinWidth<TLength> | Array<AtRule$MinWidth<TLength>>,
  "-ms-min-zoom"?: AtRule$MinZoom | Array<AtRule$MinZoom>,
  "-ms-orientation"?: AtRule$Orientation | Array<AtRule$Orientation>,
  "-ms-user-zoom"?: AtRule$UserZoom | Array<AtRule$UserZoom>,
  "-ms-width"?: AtRule$Width<TLength> | Array<AtRule$Width<TLength>>,
  "-ms-zoom"?: AtRule$Zoom | Array<AtRule$Zoom>,
  "-o-orientation"?: AtRule$Orientation | Array<AtRule$Orientation>,
  height?: AtRule$Height<TLength> | Array<AtRule$Height<TLength>>,
...
type AtRule$Size<TLength> = TLength | "auto" | "landscape" | "portrait" | string;
...
type AtRule$UserZoom = "-ms-zoom" | "fixed" | "zoom";
...
type DataType$SingleTransition<TTime> = DataType$TimingFunction | TTime | "all" | "none" | string;

type DataType$StepTimingFunction = "step-end" | "step-start" | string;

type DataType$TimingFunction = DataType$CubicBezierTimingFunction | DataType$StepTimingFunction | "linear";
