...
class ResourceSavingScene extends React.Component {
  render() {
    ...
    if ((_reactNativeScreens.screensEnabled === null || _reactNativeScreens.screensEnabled === void 0 ? void 0 : (0, _reactNativeScreens.screensEnabled)()) && this.props.enabled && _reactNative.Platform.OS !== 'web') {
      const {
        isVisible,
        ...rest
