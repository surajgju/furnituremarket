...
class KeyboardManager extends React.Component {
  constructor(...args) {
    ...
    _defineProperty(this, "handlePageChangeStart", () => {
      ...
      const input = _reactNative.TextInput.State.currentlyFocusedInput ? _reactNative.TextInput.State.currentlyFocusedInput() : _reactNative.TextInput.State.currentlyFocusedField(); // When a page change begins, blur the currently focused input
