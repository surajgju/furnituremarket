...
export default function useLinking(ref: React.RefObject<NavigationContainerRef>, { enabled, prefixes, config, getInitialURL, subscribe, getStateFromPath, }: LinkingOptions): {
    getInitialState: () => Promise<(Partial<Pick<Readonly<{
        key: string;
        index: number;
        routeNames: string[];
