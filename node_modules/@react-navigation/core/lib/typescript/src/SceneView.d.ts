 ...
 */
export default function SceneView<State extends NavigationState, ScreenOptions extends {}, EventMap extends EventMapBase>({ screen, route, navigation, routeState, getState, setState, options, }: Props<State, ScreenOptions, EventMap>): JSX.Element;
export {};
