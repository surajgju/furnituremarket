...
exports.default = createMaterialBottomTabNavigator;
...
function createMaterialBottomTabNavigator(routes, config = {}) {
  class NavigationView extends React.Component {
    constructor(...args) {
      ...
      _defineProperty(this, "_getBadge", ({
        route
      }) => {
        const {
          descriptors
    ...
    render() {
      ...
      return /*#__PURE__*/React.createElement(_MaterialBottomTabView.default, _extends({}, options, {
  ...
  const router = (0, _reactNavigation.TabRouter)(routes, config); // TODO: don't have time to fix it right now
  // @ts-ignore
